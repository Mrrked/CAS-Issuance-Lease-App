      ...
      <div class="flex flex-col items-center justify-center col-span-3 gap-2">
        ...
        <div class="flex h-full gap-1">
          <input
            ...
            :key="index"
            v-model="forRecordingGroupStore.forRecordingGroupForm.PBL.pcs_code[value]"
            ref="pcsCodeRefs"
            maxlength="1"
            @keydown="onKeydownPcs($event, forRecordingGroupStore.forRecordingGroupForm.PBL.pcs_code, index)"
            @keydown.backspace="onBackspacePcs(forRecordingGroupStore.forRecordingGroupForm.PBL.pcs_code, index)"
      ...
      <div class="flex flex-col items-center justify-center col-span-3 gap-2">
        ...
        <div class="flex h-full gap-1">
          <input
            ...
            :key="index"
            v-model="forRecordingGroupStore.forRecordingGroupForm.PBL.phase[value]"
            ref="phaseRefs"
            maxlength="1"
            @keydown="onKeydownPhase($event, forRecordingGroupStore.forRecordingGroupForm.PBL.phase, index)"
            @keydown.backspace="onBackspacePhase(forRecordingGroupStore.forRecordingGroupForm.PBL.phase, index)"
            class="text-xl font-semibold text-center uppercase border rounded outline-none border-neutral-500 dark:bg-black dark:border-neutral-700 w-11 focus:dark:border-primary focus:border-primary hover:dark:border-primary hover:border-primary"
          />
        </div>
      </div>
      <div class="flex flex-col items-center justify-center col-span-4 gap-2">
        ...
        <div class="flex h-full gap-1">
          <input
            ...
            :key="index"
            v-model="forRecordingGroupStore.forRecordingGroupForm.PBL.block[value]"
            ref="blockRefs"
            maxlength="1"
            @keydown="onKeydownBlock($event, forRecordingGroupStore.forRecordingGroupForm.PBL.block, index)"
            @keydown.backspace="onBackspaceBlock(forRecordingGroupStore.forRecordingGroupForm.PBL.block, index)"
            class="text-xl font-semibold text-center uppercase border rounded outline-none border-neutral-500 dark:bg-black dark:border-neutral-700 w-11 focus:dark:border-primary focus:border-primary hover:dark:border-primary hover:border-primary"
          />
        </div>
      </div>
      ...
      <div class="flex flex-col items-center justify-center col-span-7 gap-2">
        ...
        <div class="flex h-full gap-1">
          <input
            ...
            :key="index"
            v-model="forRecordingGroupStore.forRecordingGroupForm.PBL.lot[value]"
            ref="lotRefs"
            maxlength="1"
            @keydown="onKeydownLot($event, forRecordingGroupStore.forRecordingGroupForm.PBL.lot, index)"
            @keydown.backspace="onBackspaceLot(forRecordingGroupStore.forRecordingGroupForm.PBL.lot, index)"
            class="text-xl font-semibold text-center uppercase border rounded outline-none border-neutral-500 dark:bg-black dark:border-neutral-700 w-11 focus:dark:border-primary focus:border-primary hover:dark:border-primary hover:border-primary"
          />
        </div>
      </div>
      ...
      <div class="flex flex-col items-center justify-center col-span-4 gap-2">
        ...
        <div class="flex h-full gap-1">
          <input
            ...
            :key="index"
            v-model="forRecordingGroupStore.forRecordingGroupForm.PBL.unit_code[value]"
            ref="unitCodeRefs"
            maxlength="1"
            @keydown="onKeydownUnitCode($event, forRecordingGroupStore.forRecordingGroupForm.PBL.unit_code, index)"
            @keydown.backspace="onBackspaceUnitCode(forRecordingGroupStore.forRecordingGroupForm.PBL.unit_code, index)"
            class="text-xl font-semibold text-center uppercase border rounded outline-none border-neutral-500 dark:bg-black dark:border-neutral-700 w-11 focus:dark:border-primary focus:border-primary hover:dark:border-primary hover:border-primary"
          />
        </div>
      </div>
