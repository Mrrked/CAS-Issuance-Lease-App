    ...
    <Tabs value="0">
      ...
      <TabPanels>
        <TabPanel value="0" class="flex flex-col items-start justify-start ">
          <Fieldset legend="Form" class="min-w-80">
        ...
        <TabPanel value="1" class="flex flex-col items-start justify-start ">
          <Fieldset legend="Invoice Date" class="min-w-80">
            <div class="flex flex-col gap-2">
              <InputGroup>
                <InputGroupAddon>
                  <label for="year" class="font-bold w-28 text-content-background">
                    Select Year
                  </label>
                </InputGroupAddon>
                <Select
              ...
              <InputGroup>
                <InputGroupAddon>
                  <label for="month" class="font-bold w-28 text-content-background">
                    Select Month
                  </label>
                </InputGroupAddon>
                <Select
