      ...
      <div class="flex flex-col items-center justify-center col-span-3 gap-2">
        ...
        <div class="flex h-full gap-1">
          <input
            ...
            :key="index"
            v-model="forBillingGroupStore.forBillingGroupForm.PBL.pcs_code[value]"
            ref="pcsCodeRefs"
            maxlength="1"
            @keydown="onKeydownPcs($event, forBillingGroupStore.forBillingGroupForm.PBL.pcs_code, index)"
            @keydown.backspace="onBackspacePcs(forBillingGroupStore.forBillingGroupForm.PBL.pcs_code, index)"
      ...
      <div class="flex flex-col items-center justify-center col-span-3 gap-2">
        ...
        <div class="flex h-full gap-1">
          <input
            ...
            :key="index"
            v-model="forBillingGroupStore.forBillingGroupForm.PBL.phase[value]"
            ref="phaseRefs"
            maxlength="1"
            @keydown="onKeydownPhase($event, forBillingGroupStore.forBillingGroupForm.PBL.phase, index)"
            @keydown.backspace="onBackspacePhase(forBillingGroupStore.forBillingGroupForm.PBL.phase, index)"
            class="text-xl font-semibold text-center uppercase border rounded outline-none border-neutral-500 dark:bg-black dark:border-neutral-700 w-11 focus:dark:border-primary focus:border-primary hover:dark:border-primary hover:border-primary"
          />
        </div>
      </div>
      <div class="flex flex-col items-center justify-center col-span-4 gap-2">
        ...
        <div class="flex h-full gap-1">
          <input
            ...
            :key="index"
            v-model="forBillingGroupStore.forBillingGroupForm.PBL.block[value]"
            ref="blockRefs"
            maxlength="1"
            @keydown="onKeydownBlock($event, forBillingGroupStore.forBillingGroupForm.PBL.block, index)"
            @keydown.backspace="onBackspaceBlock(forBillingGroupStore.forBillingGroupForm.PBL.block, index)"
            class="text-xl font-semibold text-center uppercase border rounded outline-none border-neutral-500 dark:bg-black dark:border-neutral-700 w-11 focus:dark:border-primary focus:border-primary hover:dark:border-primary hover:border-primary"
          />
        </div>
      </div>
      ...
      <div class="flex flex-col items-center justify-center col-span-7 gap-2">
        ...
        <div class="flex h-full gap-1">
          <input
            ...
            :key="index"
            v-model="forBillingGroupStore.forBillingGroupForm.PBL.lot[value]"
            ref="lotRefs"
            maxlength="1"
            @keydown="onKeydownLot($event, forBillingGroupStore.forBillingGroupForm.PBL.lot, index)"
            @keydown.backspace="onBackspaceLot(forBillingGroupStore.forBillingGroupForm.PBL.lot, index)"
            class="text-xl font-semibold text-center uppercase border rounded outline-none border-neutral-500 dark:bg-black dark:border-neutral-700 w-11 focus:dark:border-primary focus:border-primary hover:dark:border-primary hover:border-primary"
          />
        </div>
      </div>
      ...
      <div class="flex flex-col items-center justify-center col-span-4 gap-2">
        ...
        <div class="flex h-full gap-1">
          <input
            ...
            :key="index"
            v-model="forBillingGroupStore.forBillingGroupForm.PBL.unit_code[value]"
            ref="unitCodeRefs"
            maxlength="1"
            @keydown="onKeydownUnitCode($event, forBillingGroupStore.forBillingGroupForm.PBL.unit_code, index)"
            @keydown.backspace="onBackspaceUnitCode(forBillingGroupStore.forBillingGroupForm.PBL.unit_code, index)"
            class="text-xl font-semibold text-center uppercase border rounded outline-none border-neutral-500 dark:bg-black dark:border-neutral-700 w-11 focus:dark:border-primary focus:border-primary hover:dark:border-primary hover:border-primary"
          />
        </div>
      </div>
