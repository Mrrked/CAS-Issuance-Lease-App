<script lang="ts" setup>
  ...
  const testGenerateBillingInvoice = () => {
    ...
    const PDF_BLOB = issuanceStore.handleActionGenerateInvoicePDFBlob([{
  ...
  <div class="flex flex-col w-full h-full gap-3 pt-4">
    <Tabs value="0">
      ...
      <TabPanels>
        ...
        <TabPanel value="2" class="flex flex-col items-start justify-start ">
          <Button @click="testGenerateBillingInvoice"
            raised
            type="submit"
            label="Generate Billing Invoice Draft"
            icon="pi pi-file"
          />
        </TabPanel>
      </TabPanels>
