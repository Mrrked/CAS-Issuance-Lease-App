      ...
      <div class="flex flex-col items-center justify-center col-span-3 gap-2">
        ...
        <div class="flex h-full gap-1">
          <input
            ...
            ref="pcsCodeRefs"
            maxlength="1"
            @input="onInputPcs(perBillTypeRunStore.perBillTypeRunForm.PBL.pcs_code, index)"
      ...
      <div class="flex flex-col items-center justify-center col-span-3 gap-2">
        ...
        <div class="flex h-full gap-1">
          <input
            ...
            ref="phaseRefs"
            maxlength="1"
            @input="onInputPhase(perBillTypeRunStore.perBillTypeRunForm.PBL.phase, index)"
      ...
      <div class="flex flex-col items-center justify-center col-span-4 gap-2">
        ...
        <div class="flex h-full gap-1">
          <input
            ...
            ref="blockRefs"
            maxlength="1"
            @input="onInputBlock(perBillTypeRunStore.perBillTypeRunForm.PBL.block, index)"
      ...
      <div class="flex flex-col items-center justify-center col-span-7 gap-2">
        ...
        <div class="flex h-full gap-1">
          <input
            ...
            ref="lotRefs"
            maxlength="1"
            @input="onInputLot(perBillTypeRunStore.perBillTypeRunForm.PBL.lot, index)"
      ...
      <div class="flex flex-col items-center justify-center col-span-4 gap-2">
        ...
        <div class="flex h-full gap-1">
          <input
            ...
            ref="unitCodeRefs"
            maxlength="1"
            @input="onInputUnitCode(perBillTypeRunStore.perBillTypeRunForm.PBL.unit_code, index)"
