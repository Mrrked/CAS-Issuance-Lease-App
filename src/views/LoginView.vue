...
<template>
  <section class="flex items-center justify-center w-full min-h-screen p-4">
    <div class="flex flex-col w-full overflow-hidden rounded-lg big-shadow sm:flex-row sm:w-11/12 lg:w-9/12 xl:w-7/12">
      <div class="flex flex-col items-center justify-center flex-1 gap-5 p-7 bg-gradient-to-r from-[#6D151A] via-[#620C16] to-[#550A13] ">
        <div class="flex items-center justify-center text-5xl font-bold ">
          <svg class="w-20 h-20 sm:w-40 sm:h-40" preserveAspectRatio="xMidYMid meet" viewBox="0 30.492 338.31600000000003 333.23400000000004" xmlns="http://www.w3.org/2000/svg" version="1.0" style="max-height: 500px" width="338.31600000000003" height="333.23400000000004">
      ...
      <form v-focustrap @submit.prevent="handleExecuteLogin" class="flex flex-col justify-between flex-1 gap-7 p-7">
        ...
        <div class="flex flex-col gap-4">
          <div class="flex flex-col gap-2">
            <label for="user_id" class="font-bold">
              User ID
            </label>
            <InputText
              name="user_id"
          ...
          <div class="flex flex-col gap-2">
            ...
            <InputText
              ...
              type="password"
              v-model="password"
              placeholder="Must be 5 - 10 characters"
              minlength="5"
              maxlength="10"
              required
              autocomplete="off"
          ...
          <button
            type="submit"
            class="w-full px-10 py-3 text-sm font-semibold tracking-wide transition-transform duration-300 rounded-sm shadow-sm outline-none text-surface-50 shadow-black hover:scale-105 focus:scale-105 bg-gradient-to-r from-primary-500 via-primary-600 to-primary-700"
          >
            LOGIN
          </button>
        </div>
